...
class ConstraintLayoutLab : ComponentActivity() {
...
@Preview(showBackground = true)
@Composable
fun LargeConstraintLayoutPreview2() {
    CodelabcomposelayoutTheme {
        LargeConstraintLayout2()
    }
}
